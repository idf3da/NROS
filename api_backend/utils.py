...
def predictWinters(data,alpha_final,beta_final,gamma_final,slen,n_preds = 1,scaling_factor = 2.5):
...
def predict_next_day(data,scaler,model,predict_range = 1,do_scale = True,batch = 32,before_range = 5):
...
def predict_step(step,scaler,model,predict_range = 1,do_scale = True,batch = 32,before_range = 5):
