<template>
    <v-app id="web_ui">
        ...
        <v-app-bar app clipped-left dense flat hide-on-scrol overlap style="background: transparent;">
            <v-img src="projectIconWhite.png" max-height="40" max-width="40"></v-img>

            <div class="ml-2" v-if="currentRouteName !== 'Home'">
                <v-toolbar-title>Neuro Retail Optimization System</v-toolbar-title>
            </div>
                            ...
                            <ValidationObserver ref="signInObserver">
                                <form class="login">
                                    <ValidationProvider v-slot="{ errors }" name="Name" rules="required|min:5|max:12">
                                        <v-text-field color="red" v-model="name" :counter="12" :error-messages="errors"
                                                      label="Name" hint="Enter your name" required></v-text-field>
                                    </ValidationProvider>

                                    <ValidationProvider v-slot="{ errors }" name="Password" rules="required|min:8">
                                        <v-text-field color="red" v-model="password" :error-messages="errors"
                            ...
                            <ValidationObserver ref="signUpObserver">
                                <form class="login">
                                    ...
                                    <ValidationProvider v-slot="{ errors }" name="E-Mail" rules="required|email">
                                        <v-text-field color="red" v-model="email" :error-messages="errors"
                                                      label="E-Mail" hint="Enter your E-Mail" required></v-text-field>
                                    </ValidationProvider>

                                    <ValidationProvider vid="password" v-slot="{ errors }" name="Password"
                                    ...
                                    <ValidationProvider v-slot="{ errors }" name="Password repeat"
                                                        rules="required|confirmed:password">
                                        <v-text-field color="red" v-model="passwordRepeat" :error-messages="errors"
                                                      :append-icon="showRepeatPassword ? 'mdi-eye' : 'mdi-eye-off'"
                                                      :type="showRepeatPassword ? 'text' : 'password'"
                                                      label="Password Repeat" hint="Enter your password again"
    ...
    export default {
        ...
        methods: {
            ...
            signUp: async function () {
                ...
                if (isValid) {
                    this.$store.dispatch(AUTH_SIGN_UP_REQUEST, {
                        name,
                        email,
                        password,
                        passwordRepeat
