<template>
    <v-app id="web_ui">
        ...
        <v-app-bar app clipped-left :absolute="currentRouteName === 'Home'" dense flat hide-on-scrol overlap
                   :style="currentRouteName === 'Home' ? 'background: transparent' : ''">
        ...
        <v-navigation-drawer v-if="currentRouteName !== 'Home'" v-model="sidebar" hide-overlay app clipped permanent
                             expand-on-hover floating width="200">
            <v-list dense>
