<template>
    <v-app id="web_ui">
        ...
        <v-app-bar app clipped-left dense flat hide-on-scrol overlap>
            ...
            <v-menu v-if="isAuthenticated" offset-y close-on-click>
                <template v-slot:activator="{on}">
        ...
        <v-navigation-drawer v-model="sidebar" hide-overlay mini-variant-width="50px" app clipped permanent
                             expand-on-hover floating width="170px">
            <v-list dense>
        ...
        methods: {
            ...
            signIn: async function () {
                ...
                if (isValid) {
                    ...
                    this.$store.dispatch(AUTH_SIGN_IN_REQUEST, {name, password})
                        .then((success) => {
                            if (success) {
                                this.name = "";
                                this.password = "";
            ...
            signUp: async function () {
                ...
                if (isValid) {
                    this.$store.dispatch(AUTH_SIGN_UP_REQUEST, {name, email, password, passwordRepeat})
                        .then((response) => {
