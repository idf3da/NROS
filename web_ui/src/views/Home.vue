		...
		<v-container fluid grid-list-md>
			<v-layout>
				<v-flex>
					...
					<!-- Это нужно пофиксить!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!11
					!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
					!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1 -->
					<h6 class="grey--text text--darken-4">.</h6>
					...
					<v-card dark outlined>
						<v-card-text class="px-0">
							<yandex-map :zoom="13" :coords="[55.753, 37.62]" :controls="[]" style="height: 300px;" :placemarks="placemarks" @map-was-initialized="initHandler">
								...
								<ymap-marker :coords="[55.755, 37.63]" marker-id="4" hint-content="Store" :icon="storeIcon" />
							</yandex-map>
						</v-card-text>
					</v-card>
				</v-flex>
	...
	export default {
		...
		data() {
			return {
				...
				storeIcon: {
					layout: "default#imageWithContent",
					imageHref: "https://cdn.icon-icons.com/icons2/1706/PNG/512/3986701-online-shop-store-store-icon_112278.png",
					imageSize: [43, 43],
					imageOffset: [0, 0],
					contentOffset: [0, 15],
					contentLayout: '<div style="background: red; width: 50px; color: #FFFFFF; font-weight: bold;">$[properties.iconContent]</div>',
